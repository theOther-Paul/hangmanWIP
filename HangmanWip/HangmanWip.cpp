...
std::string TemporaryStringMemo;
...
{
    std::string WordToGuess; //the word generated by the GetValidWord() function and stored temporary in the global variable TemporaryStringMemo
    GetValidWord();          //need to pass the random string to std::string WordToGuess
    WordToGuess = TemporaryStringMemo;
    std::string UserGuess;
    std::cout << "\nGuess the letter : ";
    getline(std::cin, UserGuess); //until this point, all works as intended
